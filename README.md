...
NEXT_PUBLIC_DATA_SOURCE_UPDATE_DATE=
```

| Parameter                                    | Type   | Description                                                                                                                                                                        |
| -------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **NEXT_PUBLIC_GEOAPIFY_API_KEY**             | string | Key to enable the map. Can be created here: [https://www.geoapify.com/get-started-with-maps-api#create-project](https://www.geoapify.com/get-started-with-maps-api#create-project) |
| **NEXT_PUBLIC_API_URL**                      | string | URL to the API instance, e.g. on local it can be `http://localhost:3000`                                                                                                           |
| **NEXT_PUBLIC_NAME**                         | string | The custom name of your application. It is displayed in the header and titles across the website                                                                                   |
| **NEXT_PUBLIC_CONTACT_MAIL**                 | string | Email used in contact dialog on a map view                                                                                                                                         |
| **NEXT_PUBLIC_GOOGLE_ANALYTICS_TRACKING_ID** | string | Google Analytics 4 tracking ID                                                                                                                                                     |
| **NEXT_PUBLIC_DATA_SOURCE_UPDATE_DATE**      | date   | Last data update date, manually entered (displayed in tooltips)                                                                                                                    |
